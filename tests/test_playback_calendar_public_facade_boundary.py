...
def test_calendar_router_does_not_import_private_users_or_system_modules():
...
def test_calendar_page_uses_public_facades_for_permission_and_template(monkeypatch):
    ...
    monkeypatch.setattr(calendar_router.system_service, "get_common_vars", fake_get_common_vars)
...
def test_calendar_page_redirects_unauthenticated_before_permission(monkeypatch):
    ...
    monkeypatch.setattr(calendar_router.system_service, "get_common_vars", fail_get_common_vars)

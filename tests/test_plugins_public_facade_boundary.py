...
def test_plugins_router_does_not_import_private_users_auth_or_system_public_service():
...
def test_plugins_page_uses_permission_facade_and_direct_template_context(monkeypatch):
    ...
    monkeypatch.setattr(plugins_router, "get_common_vars", fake_get_common_vars)
...
def test_plugins_page_redirects_unauthenticated_before_permission(monkeypatch):
    ...
    monkeypatch.setattr(plugins_router, "get_common_vars", fail_get_common_vars)

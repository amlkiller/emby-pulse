...
* `app/core/` owns reusable cross-cutting runtime helpers used by multiple backend areas, such as security, sessions, database access, configuration, middleware implementations, and shared adapters.
